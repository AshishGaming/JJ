...
export const compliments = [
  "Je hebt iets kalms, maar ook iets dat blijft.",
  "Bij jou voelt stilte nooit ongemakkelijk.",
  "Je hoeft niets te bewijzen om indruk te maken.",
  "Elegant, op een manier die vanzelf gaat.",
  "Bij jou voelt alles net iets warmer dan ergens anders.",
  "Je hebt een uitstraling die je niet kunt nadoen.",
  "Je voelt als een liedje dat precies op het juiste moment komt.",
  "Je bent iemand die je niet snel vergeet."
];


export const magazines = [
  {
    title: "Editie I — Jayani",
    text:
      "Lieve Jayani,\n\nDit is geen spelletje.\nDit is een klein plekje,\nwaar alles even om jou draait.\n\nOmdat jij vandaag 21 wordt.\nEn omdat je dat mag voelen."
  },
  {
    title: "Editie II — Jij",
    text:
      "Je hebt iets bijzonders.\n\nJe hoeft niet hard te zijn om op te vallen.\nJe hoeft niets te bewijzen.\n\nJe bent er gewoon.\nEn dat is al genoeg."
  },
  {
    title: "Editie III — Momenten",
    text:
      "Sommige momenten blijven hangen.\n\nNiet omdat ze perfect waren,\nmaar omdat ze echt waren.\n\nNet als jij."
  },
  {
    title: "Editie IV — Elegantie",
    text:
      "Elegantie is niet perfect zijn.\nHet is jezelf blijven,\nook als niemand kijkt.\n\nDat doe jij vanzelf."
  },
  {
    title: "Editie V — Vandaag",
    text:
      "Vandaag draait het even om jou.\n\nNiet om wat moet.\nNiet om wat hoort.\n\nMaar om wie jij bent.\nGeniet ervan 💜"
  }
];


// Hartjes op vaste plekken (1920x1080)
export const hearts = [
  { id: "h1", x: 260, y: 740 },
  { id: "h2", x: 1180, y: 560 },
  { id: "h3", x: 1580, y: 820 }
